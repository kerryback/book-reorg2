...
and consider buying $\delta$ shares of the stock and borrowing an amount $B$ at the risk-free rate. The portfolio value at maturity will be:
...
This gives us our delta formula @eq-oneperioddelta. We can solve for the amount to borrow:
...
$$C = \delta S - B = \delta S - e^{-rt}(\delta S_u - C_u)\,.$$ {#eq-oneperiodcall}
