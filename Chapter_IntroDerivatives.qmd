...
A Derivative security is a financial instruments the value of which is derived from an underlying asset, index, or rate. Derivative securities are used for hedging risks and for speculation. The underlying assets can be stocks, bonds, commodities, currencies, interest rates, or market indices. The fundamental characteristic of a derivative security is that its value fluctuates based on changes in the price of the underlying asset.
